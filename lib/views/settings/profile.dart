...
import 'package:carpooling/controllers/profileSettingController.dart';
import 'package:carpooling/views/settings/displayCNIC.dart';

import 'package:carpooling/views/settings/displayName.dart';
import 'package:carpooling/views/settings/email_verification.dart';
import 'package:carpooling/views/settings/getLicense.dart';
import 'package:carpooling/views/settings/getNominee.dart';
import 'package:carpooling/views/settings/getWorkingDetails.dart';
import 'package:carpooling/views/settings/setDataTemplate.dart';
import 'package:carpooling/widgets/custom_text.dart';
import 'package:carpooling/widgets/profileItem.dart';
            ...
            child: Column(
              children: [
                ...
                ProfileItem(
                    ...
                    value: "verified",
                    func: () {
                      Get.to(() => GetCitizenship(isreadonly: false));
                    }),
                ProfileItem(
                    title: "License",
