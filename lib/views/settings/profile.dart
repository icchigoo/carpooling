import 'package:carpooling/views/settings/getCNIC.dart';
        ...
        child: ListView(
          children: [
            ...
            ProfileItem(
                title: "Phone No.",
                icon: Icons.phone,
                value: "+977 344 5055109",
                func: () {}),
            ProfileItem(
                title: "Email",
                icon: Icons.email,
                value: "mug123@gmail.com",
                func: () {
                  Get.to(() => SetDataTemplate(
      ...
      body: Container(
        ...
        child: ListView(
          children: [
            ...
            ProfileItem(
                title: "CitizenshipNum",
                icon: Icons.perm_identity,
                value: "verified",
                func: () {
                  Get.to(() => GetcitizenshipNum(isreadonly: false));
                }),
            ProfileItem(
                title: "License",
