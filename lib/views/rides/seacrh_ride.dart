import 'dart:math';
import 'package:carpooling/views/rides/search_rides_response.dart';
...
class _SearchRideState extends State<SearchRide> {
  ...
  // String startAddressController.text = '';
  // String destinationAddressController.text = '';
...
// showing the route
              ...
              //               SizedBox(height: 5),
              //               ElevatedButton(
              //                 onPressed: (startAddressController.text != '' &&
